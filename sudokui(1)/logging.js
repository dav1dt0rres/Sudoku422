...
function logEvent(event, customName, customInfo) {
  console.log("Loggin an event"+" "+event.type+" "+customName)
...
// error-prone process, it can be easier to use '/
//
/////////////////////////////////////////////////////////////////////////////
...
function sendNetworkLog(
    ...
    state,
    version) {
  var formid = "e/1FAIpQLSdqszL9tv_HyAZH2AI0VewAsPv_En2LAkP-3fY_7SxuD5sP2Q";
  var data = {
    "entry.940655902": uid,
    "entry.1752005494": time,
    "entry.490410680": Name,
    "entry.1093328982": target,
    "entry.248363543": info,
    "entry.385370013": state,
    "entry.1999901461": version
  };
  var params = [];
  for (key in data) {
